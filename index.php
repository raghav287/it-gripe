...
<head>
    ...
    <title>ItGripe Foundation</title>
    ...
    <style>
    /* Hide the dropdown arrow only for the Contact Us menu item on this page */
    .main-menu>ul>li.contact-link>a::after {
        display: none;
        content: none;
    }

    .main-menu>ul>li.about-link>a::after {
        display: none;
        content: none;
    }

    .main-menu>ul>li.home-link>a::after {
        display: none;
        content: none;
    }
...
<body>
            ...
            <div class="bd-offcanvas-wrapper">
                <div class="bd-offcanvas-content">
                    ...
                    <div class="bd-offcanvas-about d-none d-lg-block mb-30">
                        ...
                        <p>
                            Empowering learners and educators with a comprehensive platform
                            that bridges the gap between traditional and modern education.
                            iStudy inspires excellence in education and fosters growth for a
                            brighter future.
                        </p>
                    </div>
                    <div class="bd-offcanvas-contact mb-30">
                        ...
                        <ul>
                            ...
                            <li class="d-flex align-items-center gap-10">
                                <div class="bd-offcanvas-contact-icon">
                                    <a
                                        href="https://html.topylo.com/cdn-cgi/l/email-protection#fd94939b92bd948e89889984d39e9290"><i
                                            class="fal fa-envelope"></i></a>
                                </div>
                                <div class="bd-offcanvas-contact-text">
                                    <a
                                        href="https://html.topylo.com/cdn-cgi/l/email-protection#94fdfaf2fbd4fde7e0e1f0edbaf7fbf9"><span
                                            class="__cf_email__"
                                            data-cfemail="87eee9e1e8c7eef4f3f2e3fea9e4e8ea">[email&#160;protected]</span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="bd-sidebar-cart-top-wrapper">
                <div class="bd-sidebar-cart-top p-relative">
                    ...
                    <div class="bd-sidebar-cart-close">
                        <button type="button" class="bd-sidebar-cart-close-btn cartmini-close-btn">
                ...
                <div class="bd-sidebar-cart-widget">
                    <div class="bd-sidebar-cart-widget-item">
                        ...
                        <div class="bd-sidebar-cart-content">
                            <h5 class="bd-sidebar-cart-title">
                                <a href="shop-details.html">We Solve Murders</a>
                            </h5>
                    ...
                    <div class="bd-sidebar-cart-widget-item">
                        ...
                        <div class="bd-sidebar-cart-content">
                            <h5 class="bd-sidebar-cart-title">
                                <a href="shop-details.html">The Women</a>
                            </h5>
                            <div class="bd-sidebar-cart-price-wrapper">
                                <span class="bd-sidebar-cart-price">$30.00</span>
                                <span class="bd-sidebar-cart-quantity">x1</span>
                    ...
                    <div class="bd-sidebar-cart-widget-item">
                        ...
                        <div class="bd-sidebar-cart-content">
                            <h5 class="bd-sidebar-cart-title">
                                <a href="shop-details.html">Fourth Wing</a>
                            </h5>
                            <div class="bd-sidebar-cart-price-wrapper">
    ...
    <main class="main-area">
        <!-- banner area start -->
        <section class="bd-banner-area bd-banner-one p-relative fix image-bg"
            data-background="assets/images/bg/home-one-bg.webp">
            <div class="container">
                <div class="bd-banner-shape">
                    <div class="shape-1">
                ...
                <div class="bd-banner-one-row-wrap">
                    <div class="row gy-30 align-items-center justify-content-end">
                        <div class="col-xxl-5 col-xl-6 col-lg-12">
                            <span class="bd-banner-subtitle">Welcome to ItGripe Foundation</span>
                            <h1 class="bd-banner-title small mb-20">
                                Discover
                                <span class="bd-title-underline text-secondary">
                                    2700+
                                ...
                                online courses available in the World
                            </h1>
                            <p class="bd-banner-description">
                                They are not liable for any offense caused by those who fail
                                to carry out their duties, unless it is due to negligence.
                            </p>
                            <div class="bd-banner-btn d-flex-items flex-wrap gap-30">
                                <a class="bd-btn btn-outline-border-primary" href="courses.html">Find Courses</a>
                                <a class="bd-video-btn secondary popup-video"
                        ...
                        <div class="col-xxl-7 col-xl-6 col-lg-12">
                            <div class="bd-banner-thumb-wrapper position-relative">
                                ...
                                <div class="bd-banner-tag-wrapper">
                                    <div class="bd-banner-tag-one">
                                        <div class="shape">
                                            <img src="assets/images/shape/dot-shape.webp" alt="shape" />
                                        </div>
                                        <div class="inner">
                                            <div class="icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="subtitle">Satisfied Learner</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bd-banner-tag-two">
                                        <div class="inner">
                                            <div class="icon">
                        ...
                        <div class="bd-feature-wrapper style-one wow bdFadeInUp">
                            <div class="bd-feature-item">
                                <span class="icon"><svg width="49" height="49" viewBox="0 0 49 49" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M22.5 30.5H26.5" stroke="#07A169" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M24.5 36.5V44.5" stroke="#07A169" stroke-width="3" />
                                        <path d="M16.5 44.5H32.5" stroke="#07A169" stroke-width="3"
            ...
            <div class="container">
                ...
                <div class="row gy-30">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <a href="courses.html" class="bd-category-wrapper style-one wow bdFadeInUp"
                            data-wow-delay=".4s">
                            <div class="bd-category-item">
                                <span class="bd-category-icon"><svg width="49" height="49" viewBox="0 0 49 49"
                                        ...
                                        <path
                                            ...
                                            stroke="#07A169" stroke-width="3" />
                                        <path d="M14.5 30.5048L14.5174 30.5" stroke="#07A169" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                ...
                                <div class="bd-category-content">
                                    <h6 class="bd-category-title">Graphics Design</h6>
                                    <span class="bd-category-total">30 course</span>
                                </div>
                            </div>
                        </a>
                    </div>
                            ...
                            <div class="bd-category-item">
                                <span class="bd-category-icon"><svg width="49" height="49" viewBox="0 0 49 49"
                                        ...
                                        <path
                                            ...
                                            stroke="#FFB800" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M26.5 14.5L22.5 26.5" stroke="#FFB800" stroke-width="3"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                ...
                                <div class="bd-category-content">
                                    ...
                                    <span class="bd-category-total">20 course</span>
                                </div>
                            </div>
                        </a>
                    </div>
                            ...
                            <div class="bd-category-item">
                                <span class="bd-category-icon"><svg width="49" height="49" viewBox="0 0 49 49"
                                        ...
                                        <path
                                            ...
                                            stroke="#FFB800" stroke-width="3" stroke-linecap="round" />
                                        <path d="M9.5 43.5L17.5 35.5M21.5 35.5L29.5 43.5M19.5 35.5V45.5"
                                            stroke="#FFB800" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                ...
                                <div class="bd-category-content">
                                    ...
                                    <span class="bd-category-total">25 course</span>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="courses.html" class="bd-category-wrapper style-one wow bdFadeInUp"
                            ...
                            <div class="bd-category-item">
                                ...
                                <div class="bd-category-content">
                                    ...
                                    <span class="bd-category-total">35 course</span>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="courses.html" class="bd-category-wrapper style-one wow bdFadeInUp"
                            ...
                            <div class="bd-category-item">
                                ...
                                <div class="bd-category-content">
                                    ...
                                    <span class="bd-category-total">40 course</span>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="courses.html" class="bd-category-wrapper style-one wow bdFadeInUp"
                            ...
                            <div class="bd-category-item">
                                ...
                                <div class="bd-category-content">
                                    ...
                                    <span class="bd-category-total">15 course</span>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="courses.html" class="bd-category-wrapper style-one wow bdFadeInUp"
                            ...
                            <div class="bd-category-item">
                                ...
                                <div class="bd-category-content">
                                    ...
                                    <span class="bd-category-total">10 course</span>
                                </div>
                            </div>
                        </a>
                    </div>
                            ...
                            <div class="bd-category-item">
                                <span class="bd-category-icon"><svg width="49" height="49" viewBox="0 0 49 49"
                                        ...
                                        <path
                                            ...
                                            stroke="#07A169" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M26.5 26.5C36.1 26.5 42.5 21.8334 44.5 20.5" stroke="#07A169"
        ...
        <section class="bd-about-area section-space theme-bg p-relative bd-noise-bg">
            <div class="container">
                <div class="bd-about-shape-wrap">
                    <div class="shape-1">
                        <img src="assets/images/shape/about-solid-circle.webp" alt="shape" />
                    </div>
                    <div class="shape-2">
                        <img src="assets/images/shape/about-book-shape.webp" alt="shape" />
                    </div>
                    <div class="shape-3">
                        <img src="assets/images/shape/about-wave-shape.webp" alt="shape" />
                    </div>
                    <div class="shape-4">
                        <img src="assets/images/shape/about-circle.webp" alt="shape" />
                    </div>
                </div>
                <div class="row g-5">
                        ...
                        <div class="bd-about-wrapper style-one">
                            <div class="bd-about-content-wrapper">
                                <div class="bd-section-title-wrapper">
                                    ...
                                    <h2 class="bd-section-title white-text mb-20">
                                        A New Different Way To Improve Your
                                        <span class="down-mark-line">Skills</span>
                                    </h2>
                                    <p class="bd-section-paragraph has-border-sec">
                                ...
                                <div class="bd-about-feature-list">
                                    <div class="bd-about-feature-item">
                                        ...
                                        <div class="bd-about-feature-content">
                                            ...
                                            <p class="bd-about-feature-desc">
                                                The Flexible Classes feature allows students to
                                                customize their learning schedule
                                            </p>
                                        </div>
                                    </div>
                                    <div class="bd-about-feature-item">
                                        ...
                                        <div class="bd-about-feature-content">
                                            ...
                                            <p class="bd-about-feature-desc">
                                                All trainers hold relevant certifications and advanced
                                                degrees, guaranteeing that you are learning from
                                                qualified experts
                                            </p>
                                        </div>
                                    </div>
                                    <div class="bd-about-feature-item">
                                        ...
                                        <div class="bd-about-feature-content">
                                            <h6 class="bd-about-feature-title">
                                                Build Your Career
                                            </h6>
                                            <p class="bd-about-feature-desc">
                                                Prepare for job interviews with mock interview
                                                sessions, feedback, and tips on how to present
                                ...
                                <div class="bd-about-btn">
                                    <a class="bd-btn btn-secondary-white" href="about-online-course.html">Know
                                        More</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="bd-section-title-wrapper section-title-space text-center">
                            <span class="bd-section-subtitle">Trending Courses</span>
                            <h2 class="bd-section-title">
                                Find Your <span class="down-mark-line">Course</span>
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="row gy-30">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bd-course-wrapper style-seven">
                            <a href="courses-details.html"
                                ...
                                <div class="bd-course-thumb-bg bg-1">
                                    <img src="assets/images/course/course-bg-1.webp" alt="images" />
                                </div>
                                <div class="bd-course-thumb-instructor center">
                                    <img src="assets/images/course/course-instructor-1.webp" alt="instructor" />
                                </div>
                                <div class="small-text bg-text-color">Getting Started</div>
                                <div class="bd-course-overly-title fs-200 text-white">
                                    UI/UX
                                </div>
                            </a>
                            <div class="bd-course-content">
                                <div class="bd-course-content-bottom d-flex align-items-center gap-30 mb-10">
                                    <div class="bd-course-lesson has-separator">
                                        <span><i class="fa-light fa-clock"></i> 45 Lessons</span>
                                    </div>
                                    <div class="bd-course-lesson">
                                        <span><i class="fa-sharp fa-solid fa-list"></i> 520
                                            Students</span>
                                    </div>
                                </div>
                                <h5 class="bd-course-title underline mb-10">
                                    <a href="courses-details.html">Learn SQL Using Microsoft SQL Server</a>
                                </h5>
                                <p class="bd-course-description mb-10">
                                    Empower your career with data science skills that are in
                                    high demand across industries.
                                </p>
                                <div class="bd-course-rating d-inline-flex align-items-center gap-10 mb-30">
                                    <div class="bd-course-rating-icon d-flex rating-color">
                                ...
                                <div class="bd-course-btn">
                                    <a class="bd-btn btn-outline-primary" href="courses-details.html">Register Now </a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bd-course-wrapper style-seven">
                            <a href="courses-details.html"
                                class="bd-course-thumb-wrapper bd-course-thumb-style p-relative">
                                <!-- <div class="bd-course-badge">
                                    <span class="bd-badge badge-primary">FREE</span>
                                </div> -->
                                <div class="bd-course-thumb-bg bg-2">
                                    <img src="assets/images/course/course-bg-2.webp" alt="images" />
                                </div>
                                <div class="bd-course-thumb-instructor right">
                                    <img src="assets/images/course/course-instructor-2.webp" alt="instructor" />
                                </div>
                                <div class="bd-course-text-content">
                                    <div class="text-1 fs-50 mb-5 text-white">JavaScript</div>
                                    <div class="text-2 fs-50 mb-5 text-white">
                                        For Beginners
                                    </div>
                                    <div
                                        class="text-3 fs-28 white-bg text-primary pl-10 pr-10 pt-5 pb-5 d-inline-block latter-sp-2 uppercase">
                                        Beginner
                                    </div>
                                </div>
                            </a>
                            <div class="bd-course-content">
                                <div class="bd-course-content-bottom d-flex align-items-center gap-30 mb-10">
                                    <div class="bd-course-lesson has-separator">
                                        <span><i class="fa-light fa-clock"></i> 30 Lessons</span>
                                    </div>
                                    <div class="bd-course-lesson">
                                        <span><i class="fa-sharp fa-solid fa-list"></i> 750
                                            Students</span>
                                    </div>
                                </div>
                                <h5 class="bd-course-title underline mb-10">
                                    <a href="courses-details.html">SQL for Interviews: From Basics to Advanced
                                        Questions</a>
                                </h5>
                                <p class="bd-course-description mb-10">
                                    Learn how to build responsive websites from scratch using
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bd-course-wrapper style-seven">
                            <a href="courses-details.html"
                                class="bd-course-thumb-wrapper bd-course-thumb-style p-relative">
                                <!-- <div class="bd-course-badge">
                                    <span class="bd-badge badge-secondary">10% Off</span>
                                </div> -->
                                <div class="bd-course-thumb-bg bg-3">
                                    <img src="assets/images/course/course-bg-3.webp" alt="images" />
                                </div>
                                <div class="bd-course-thumb-instructor right">
                                    <img src="assets/images/course/course-instructor-3.webp" alt="instructor" />
                                </div>
                                <div class="bd-course-text-content">
                                    <div class="text-1 fs-50 mb-5 text-white">React.js</div>
                                    <div class="text-2 fs-50 mb-25 text-white">Concepts</div>
                                    <div
                                        class="text-3 fs-28 white-bg text-primary pl-10 pr-10 pt-5 pb-5 d-inline-block latter-sp-2 uppercase">
                                        Advanced
                                    </div>
                            ...
                            <div class="bd-course-content">
                                <div class="bd-course-content-bottom d-flex align-items-center gap-30 mb-10">
                                    <div class="bd-course-lesson has-separator">
                                        <span><i class="fa-light fa-clock"></i> 40 Lessons</span>
                                    </div>
                                    <div class="bd-course-lesson">
                                        <span><i class="fa-sharp fa-solid fa-list"></i> 620
                                            Students</span>
                                    </div>
                                </div>
                                <h5 class="bd-course-title underline mb-10">
                                    <a href="courses-details.html">Soft Skills Development for Career Success</a>
                                </h5>
                                <p class="bd-course-description mb-10">
                                    Become an expert in SEO, social media marketing, and content
        ...
        <section class="bd-testimonial-area p-relative theme-bg">
            <div class="bd-testimonial-video" data-background="assets/images/bg/testimonial-bg-online-2.webp">
                <div class="bd-testimonial-video-btn animation-two">
                    <a href="https://www.youtube.com/watch?v=INY3ETimTjg" class="bd-play-btn popup-video"><i
                            class="fa-regular fa-play"></i></a>
                </div>
            </div>
            <div class="bd-testimonial-bg-two d-none d-lg-block bd-noise-bg"></div>
            <div class="container">
                <div class="row justify-content-end align-items-center">
                    <div class="col-xxl-7 col-xl-6 col-lg-6">
                        <div class="bd-testimonial-wrap section-space">
                            <div class="bd-testimonial-shape-quote">
                                <img src="assets/images/shape/testimonial-quote-icon.webp" alt="shape" />
                            </div>
                            <div class="bd-section-title-wrapper section-title-space">
                                <span class="bd-section-subtitle text-secondary">TESTIMONIALS</span>
                                <h2 class="bd-section-title white-text mb-20">
                                    What Our <span class="down-mark-line">Students</span> Saying
                                </h2>
                            </div>
                            <div class="swiper testimonialActiveFour">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="bd-testimonial-wrapper style-six">
                                            <div class="bd-testimonial-item">
                                                ...
                                                <div class="bd-testimonial-content mb-55">
                                                    <p>
                                                        The courses on iStudy have transformed my career.
                                                        The practical projects and expert instructors made
                                                        learning seamless and enjoyable. Highly recommend
                                                        it!
                                                    </p>
                                                </div>
                                                <div class="bd-testimonial-meta d-flex-between">
                                                    <div class="author">
                                                        ...
                                                        <div class="details">
                                                            <h6 class="name">Sarah Johnson</h6>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="bd-testimonial-wrapper style-six">
                                            <div class="bd-testimonial-item">
                                                ...
                                                <div class="bd-testimonial-content mb-55">
                                                    <p>
                                                        iStudy is a game-changer! The flexible schedules
                                                        and top-notch content allowed me to upskill while
                                                        managing my busy routine. Thank you, iStudy!
                                                    </p>
                                                </div>
                                                <div class="bd-testimonial-meta d-flex-between">
                                                    <div class="author">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="bd-testimonial-wrapper style-six">
                                            <div class="bd-testimonial-item">
                                                ...
                                                <div class="bd-testimonial-content mb-55">
                                                    <p>
                                                        Joining iStudy was the best decision I made this
                                                        year. The course variety and personalized learning
                                                        paths helped me achieve my professional goals with
                                                        ease.
                                                    </p>
                                                </div>
                                                <div class="bd-testimonial-meta d-flex-between">
                            ...
                            <div class="bd-testimonial-pagination bd-dots-pagination justify-content-start"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="bd-instructor-area section-space-top pb-200 " style="background-color: white;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="bd-section-title-wrapper section-title-space text-center"> <span
                                class="bd-section-subtitle">Instructor</span>
                            <h2 class="bd-section-title"> Our Course <span class="down-mark-line">Instructor</span>
                            </h2>
                        </div>
                    </div>
                </div>
                <div class="row gx-0 gy-30 align-items-center">

                    <!-- LEFT SIDE (INSTRUCTOR DETAILS) -->
                    <div class="col-xl-7">
                        <div class="instructor-details">

                            <!-- NAME + DESIGNATION -->
                            <h3 class="instructor-name">John Doe</h3>
                            <p class="instructor-role">Senior Instructor / Data Science Expert</p>

                            <!-- INFO -->
                            <!-- <div class="instructor-meta">
                                <span><i class="fa-regular fa-location-dot"></i> London, US</span>
                                <span><i class="fa-regular fa-clock"></i> Available: 8.00 am - 6.00 pm</span>
                            </div> -->

                            <!-- DESCRIPTION -->
                            <p class="instructor-desc">
                                Our course instructors are highly experienced professionals dedicated to delivering
                                quality education and practical knowledge.
                                They guide students through real-world scenarios, enhance analytical thinking, and help
                                build strong communication skills.
                                With personalized mentorship and industry exposure, students gain the confidence to
                                excel in their careers and meet potential employers successfully.
                            </p>

                            <!-- OPTIONAL BUTTON -->
                            <!-- <a href="#" class="bd-btn">View Full Profile</a> -->
                    ...
                    <!-- RIGHT SIDE (IMAGE) -->
                    <div class="col-xl-5">
                        <div class="bd-event-thumb style-two">
                            <img src="assets/images/event/event-thumb-06.webp" alt="Instructor">
                        </div>
                    </div>
        ...
        <!-- counter area start -->
        <div class="bd-counter-area bd-counter-over-top p-relative section-space-bottom">
            <div class="container">
                <div class="bd-counter-wrapper bd-counter-border">
                    <div class="p-relative fix">
                        <div class="bd-counter-style-one">
                            <div class="bd-counter-bg-2 theme-bg bd-noise-bg"></div>
                            <div class="bd-counter-item">
                                <div class="bd-counter-content">
                                    <h2 class="bd-counter-title">
                                        <span data-purecounter-duration="1" data-purecounter-end="1009"
                            ...
                            <div class="bd-counter-item">
                                <div class="bd-counter-content">
                                    <h2 class="bd-counter-title">
                                        <span data-purecounter-duration="1" data-purecounter-end="9313"
                                            class="purecounter">0</span>+
                                    </h2>
                                    <p>Active Learners</p>
                                </div>
                            ...
                            <div class="bd-counter-item">
                                <div class="bd-counter-content">
                                    <h2 class="bd-counter-title">
                                        <span data-purecounter-duration="1" data-purecounter-end="2015"
                                            class="purecounter">0</span>+
                                    </h2>
                            ...
                            <div class="bd-counter-item">
                                <div class="bd-counter-content">
                                    <h2 class="bd-counter-title">
                                        <span data-purecounter-duration="1" data-purecounter-end="1105"
                                            class="purecounter">0</span>+
                                    </h2>
                                    <p>Awards Received</p>
                                </div>
                        ...
                        <div class="bd-counter-shape-wrap">
                            <div class="shape-1">
                                <img src="assets/images/shape/counter-shape-1.webp" alt="shape" />
                            </div>
                            <div class="shape-2">
                                <img src="assets/images/shape/counter-shape-2.webp" alt="shape" />
                            </div>
                            <div class="shape-3">
                                <img src="assets/images/shape/counter-shape-6.webp" alt="shape" />
                            </div>
                            <div class="shape-4">
                                <img src="assets/images/shape/counter-shape-4.webp" alt="shape" />
                            </div>
                            <div class="shape-5">
                                <img src="assets/images/shape/counter-shape-5.webp" alt="shape" />
                            </div>
                            <div class="shape-6">
                                <img src="assets/images/shape/counter-shape-3.webp" alt="shape" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- partner area start -->
        <div class="bd-partner-area section-space theme-bg-05 bd-partner-bg fix">
            <div class="container">
                <div class="row gy-30">
                    <div class="col-xl-5 col-lg-5 col-md-12">
                        <div class="bd-section-title-wrapper">
                            <h2 class="bd-section-title mb-20">
                                Our <span class="down-mark-line">Global</span> Honorable
                                Partners
                            </h2>
                            <p class="bd-section-paragraph">
                                Global partners has been Publish the course you want, in the
                                way you want always have of control.
                            </p>
                            <p class="bd-section-paragraph">
                                <span class="text-primary fs-18 fw-6">9,500</span>+ businesses
                        ...
                        <div class="bd-career-grid">
                            <div class="bd-career-wrapper style-one">
                                <div class="bd-career-item">
                                    ...
                                    <div class="bd-career-thumb">
                                        <img src="assets/images/cta/career-cta-thumb-01.webp" alt="thumb" />
                                    </div>
                                    <div class="bd-career-content">
                                        <span class="bd-career-subtitle text-secondary">Start Your Journey
                                            Today</span>
                                        <h4 class="bd-career-title underline">
                                            <a href="#">Become an Instructor & Share Your Expertise</a>
                                        </h4>
                                        <div class="bd-career-btn">
                                            <a class="bd-btn btn-secondary btn-small"
                                                href="become-instructor.html">Learn More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="bd-career-wrapper style-one">
                                <div class="bd-career-item">
                                    ...
                                    <div class="bd-career-content">
                                        <span class="bd-career-subtitle text-primary">Unlock Your Potential</span>
                                        <h4 class="bd-career-title underline">
                                            <a href="#">Enhance Your Skills and Stay Ahead</a>
                                        </h4>
                                        <div class="bd-career-btn">
                                            <a class="bd-btn btn-primary btn-small" href="courses.html">Explore
                                                Courses</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <script defer
        ...
        data-cf-beacon='{"version":"2024.11.0","token":"9785eab8d0f0406fb028adb707058fb1","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}'
